...
The name has nothing to do with binary, or with what values it outputs by the way, it's to do with how you would map its responce in the z-plane, which is much beyond the scope of this article. 
