...
alternating from 1 to -1 across each sample, as you would expect for Nyquist. (You can see, if it oscilated any faster, we wouldn't be able to represent it at this sampling rate)
